...
- **[cowplot](https://github.com/cran/cowplot)**: Wilke, C. (2024). See also the vignette: [cowplot vignette](https://CRAN.R-project.org/web/package=cowplot).
- **[devtools](https://github.com/cran/devtools)**: Wickham, H., & Hester, J. (2022). See also the vignette: [devtools vignette](https://CRAN.R-project.org/web/package=devtools).
- **[DropletQC](https://github.com/powellgenomicslab/DropletQC)**: Muskovic, W. (2024). GitHub repository.
- **[dplyr](https://github.com/cran/dplyr)**: Wickham, H., et al. (2023). See also the vignette: [dplyr vignette](https://CRAN.R-project.org/web/package=dplyr).
- **[ggplot2](https://github.com/cran/ggplot2)**: Wickham, H. (2016). See also the vignette: [ggplot2 vignette](https://CRAN.R-project.org/web/package=ggplot2).
- **[Matrix](https://github.com/cran/Matrix)**: Bates, D., et al. (2024). See also the vignette: [Matrix vignette](https://CRAN.R-project.org/web/package=Matrix).
- **[png](https://github.com/cran/png)**: Urbanek, S. (2022). 
- **[Seurat](https://satijalab.org/seurat/)**: Satija, R., & Farrell, C., et al. (2015). See also the vignettes: [Seurat vignettes](https://satijalab.org/seurat/articles/).
